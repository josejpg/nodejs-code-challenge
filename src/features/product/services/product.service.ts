import type { FetchRequestFilters } from "../../../models/fetch-request-filters.type";
import type { FetchGetRequest } from "../../../models/fetch-request.type";
...
export class ProductService {
	...
	constructor(private readonly fetch: Fetch = new Fetch()) {}
	 ...
	 */
	public async getAll(
		filters?: Map<FetchRequestFilters, string>,
