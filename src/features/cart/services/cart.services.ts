...
export class CartService {
	...
	public async addProduct(productId: number): Promise<CartContent> {
		...
		const productInCart: boolean = cart.productList.some(
